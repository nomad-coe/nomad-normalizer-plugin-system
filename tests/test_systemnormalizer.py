...
from conftest import run_normalize, parse_file, get_template_for_structure
...
boolean_positions = (
    'parsers/template', 'tests/data/no_sim_cell_boolean_positions.json')

single_string_atom_labels = (
    'parsers/template', 'tests/data/single_string_atom_labels.json')

unknown_atom_label = (
    'parsers/template', 'tests/data/unknown_atom_label_test.json')

fcc_symmetry = (
    'parsers/template', 'tests/data/fcc_crystal_structure.json')
...
glucose_atom_labels = (
    'parsers/template', 'tests/data/glucose_atom_labels.json')
...
def test_template_example_normalizer():
    parsed_template_example = parse_file('parsers/template', 'tests/data/template.json')
...
def test_springer_normalizer():
    ...
    springer_cls = archive.run[0].system[0].m_def.all_sub_sections['springer_material'].sub_section.section_cls
